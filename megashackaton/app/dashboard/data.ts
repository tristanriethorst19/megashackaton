...
export const experts = [
  {
    name: "Hartmann & Partners",
    tagline: "EU AI Act Legal Advisory",
    focus: "Art. 22 & 52 · High-risk AI systems · Registration",
    initials: "H&P",
    location: "Berlin, Germany",
    size: "12–30 specialists",
    services: ["Legal advisory", "Regulatory filings", "Compliance audits"],
    available: true,
    rating: 4.9,
    reviewCount: 38,
    relevance: "Directly relevant to your open Art. 22 and Art. 52 action items for Workday AI.",
  },
  {
    name: "DataShield Legal",
    tagline: "GDPR & Data Protection Law Firm",
    focus: "GDPR · Art. 22 · Data protection impact assessments",
    initials: "DS",
    location: "Amsterdam, Netherlands",
    size: "20–50 specialists",
    services: ["DPIA", "GDPR compliance", "Contract review"],
    available: true,
    rating: 4.7,
    reviewCount: 61,
    relevance: "Can help with GDPR Art. 22 documentation and DPIA for your AI HR systems.",
  },
  {
    name: "Auditex AI",
    tagline: "AI Risk Management & Independent Auditing",
    focus: "EU AI Act · Art. 9 Risk management · Annual audits",
    initials: "AX",
    location: "Brussels, Belgium",
    size: "8–15 specialists",
    services: ["Risk assessments", "Independent audits", "Model drift monitoring"],
    available: false,
    rating: 4.8,
    reviewCount: 24,
    relevance: "Specialises in Art. 9 risk management and annual audits for HR tech AI systems.",
  },
];
